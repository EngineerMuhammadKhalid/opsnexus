...
import { Filter, Tag, BookOpen, AlertCircle, PlusCircle, Trash2 } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredTasks.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20 bg-gray-50 dark:bg-darklighter rounded-xl border border-dashed border-gray-300 dark:border-gray-700">
